...
class MobileDetect {
    ...
    //    'IntextTablet' => null,
        ...
        // ECS Tablets - http://www.ecs.com.tw/ECSWebSite/_Tablet_List.aspx?CategoryID=14&MenuID=107&childid=M_107&LanID=0
    ...
    public function isMobile() {
        foreach ( self::getMobileDetectionRules() as $_regex) {
            if (empty($_regex)) {
                continue;
            }
