...
class ControllerLocalisationLocation extends Controller {
	...
	protected function getList() {
        ...
        $data['sort_sort_order'] = $this->url->link('localisation/location', 'token=' . $this->session->data['token'] . '&sort=sort_order' . $url, 'SSL');
	...
	protected function getForm() {
        ...
        if (isset($this->request->post['zone'])) {
            ...
            if ($zone_info) {
                $data['zone'] = $zone_info['country'] . ' > '. $zone_info['name'];
            } else {
                $data['zone'] = '';
            }
        } else {
	...
	protected function validateForm() {
		...
		if ((utf8_strlen($this->request->post['telephone']) < 3) || (utf8_strlen($this->request->post['telephone']) > 128)) {
