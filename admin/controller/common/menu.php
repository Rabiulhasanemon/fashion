...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_ads_position'] = $this->language->get('text_ads_position');
        $data['text_article'] = $this->language->get('text_article');
		$data['text_attribute'] = $this->language->get('text_attribute');
		$data['text_attribute_profile'] = $this->language->get('text_attribute_profile');
        ...
        $data['text_event_stream'] = $this->language->get('text_event_stream');
		$data['text_category_manufacturer'] = $this->language->get('text_category_manufacturer');
		...
		$data['text_component'] = $this->language->get('text_component');
		...
		$data['text_event_participant'] = $this->language->get('text_event_participant');
		...
		$data['text_filter_profile'] = $this->language->get('text_filter_profile');
		$data['text_geo_zone'] = $this->language->get('text_geo_zone');
		$data['text_dashboard'] = $this->language->get('text_dashboard');
		$data['text_article_dashboard'] = $this->language->get('text_article_dashboard');
		$data['text_help'] = $this->language->get('text_help');
		$data['text_information'] = $this->language->get('text_information');
		$data['text_landing_page'] = $this->language->get('text_landing_page');
		...
		$data['text_order_item'] = $this->language->get('text_order_item');
		$data['text_order_status'] = $this->language->get('text_order_status');
		$data['text_opencart'] = $this->language->get('text_opencart');
		$data['text_payment'] = $this->language->get('text_payment');
		$data['text_product'] = $this->language->get('text_product');
		$data['text_permanent_redirect'] = $this->language->get('text_permanent_redirect');
		$data['text_product_update_request'] = $this->language->get('text_product_update_request');
		$data['text_restock_request'] = $this->language->get('text_restock_request');
		...
		$data['article_dashboard'] = $this->url->link('common/article_dashboard', 'token=' . $this->session->data['token'], 'SSL');
        $data['blog_category'] = $this->url->link('blog/category', 'token=' . $this->session->data['token'], true);
        $data['blog_event_stream'] = $this->url->link('blog/event_stream', 'token=' . $this->session->data['token'], true);
        $data['blog_article'] = $this->url->link('blog/article', 'token=' . $this->session->data['token'], true);
        $data['blog_comment'] = $this->url->link('blog/comment', 'token=' . $this->session->data['token'], true);
		...
		$data['ads'] = $this->url->link('design/ads', 'token=' . $this->session->data['token'], 'SSL');
		$data['ads_position'] = $this->url->link('design/ads_position', 'token=' . $this->session->data['token'], 'SSL');
		$data['attribute'] = $this->url->link('catalog/attribute', 'token=' . $this->session->data['token'], 'SSL');
		$data['attribute_profile'] = $this->url->link('catalog/attribute_profile', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['navigation'] = $this->url->link('catalog/navigation', 'token=' . $this->session->data['token'], 'SSL');
		$data['category_manufacturer'] = $this->url->link('catalog/category_manufacturer', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['sms'] = $this->url->link('marketing/sms', 'token=' . $this->session->data['token'], 'SSL');
		$data['coupon'] = $this->url->link('marketing/coupon', 'token=' . $this->session->data['token'], 'SSL');
		$data['component'] = $this->url->link('setting/component', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['event_participant'] = $this->url->link('form/event_participant', 'token=' . $this->session->data['token'], 'SSL');
		$data['enquiry'] = $this->url->link('catalog/enquiry', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['filter_profile'] = $this->url->link('catalog/filter_profile', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['landing_page'] = $this->url->link('catalog/landing_page', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['operator'] = $this->url->link('operator/operator', 'token=' . $this->session->data['token'], 'SSL');
		$data['offer'] = $this->url->link('catalog/offer', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['sale_payment'] = $this->url->link('sale/payment', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['product_update_request'] = $this->url->link('catalog/product_update_request', 'token=' . $this->session->data['token'], 'SSL');
		$data['restock_request'] = $this->url->link('catalog/restock_request', 'token=' . $this->session->data['token'], 'SSL');
		$data['question'] = $this->url->link('catalog/question', 'token=' . $this->session->data['token'], 'SSL');
		$data['report_sale_order'] = $this->url->link('report/sale_order', 'token=' . $this->session->data['token'], 'SSL');
		$data['report_sale_order_item'] = $this->url->link('report/sale_order/item', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['permanent_redirect'] = $this->url->link('setting/permanent_redirect', 'token=' . $this->session->data['token'], 'SSL');
