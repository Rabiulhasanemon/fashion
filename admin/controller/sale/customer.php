...
class ControllerSaleCustomer extends Controller
{
    ...
    protected function validateForm()
    {
        ...
        $customer_info = $this->model_sale_customer->getCustomerByTelephone($this->request->post['telephone']);
    ...
    public function export()
    {
        ...
        foreach ($results as $result) {
            ...
            $str .= $arrayToCsvLine([$result['name'], $result['email']]).',="'.$result['telephone'].'"'.PHP_EOL;
        }
