...
class ControllerSaleReturn extends Controller {
	...
	protected function getForm() {
        ...
        $data['entry_freight'] = $this->language->get('entry_freight');
        ...
        if (isset($this->error['freight'])) {
            $data['error_freight'] = $this->error['freight'];
        } else {
            $data['error_freight'] = '';
        }

        if (isset($this->error['tracking_no'])) {
            $data['error_tracking_no'] = $this->error['tracking_no'];
        } else {
            $data['error_tracking_no'] = '';
        }
        ...
        if (isset($this->request->post['freight'])) {
            $data['freight'] = $this->request->post['freight'];
        } elseif (!empty($return_info)) {
            $data['freight'] = $return_info['freight'];
        } else {
            $data['freight'] = '';
        }

        if (isset($this->request->post['tracking_no'])) {
            $data['tracking_no'] = $this->request->post['tracking_no'];
        } elseif (!empty($return_info)) {
            $data['tracking_no'] = $return_info['tracking_no'];
        } else {
            $data['tracking_no'] = '';
        }
	...
	protected function validateForm() {
        ...
        if ((utf8_strlen($this->request->post['freight']) < 1) || (utf8_strlen($this->request->post['freight']) > 96)) {
            $this->error['freight'] = $this->language->get('error_freight');
        }

        if ((utf8_strlen($this->request->post['tracking_no']) < 1) || (utf8_strlen($this->request->post['tracking_no']) > 96)) {
            $this->error['tracking_no'] = $this->language->get('error_tracking_no');
        }
