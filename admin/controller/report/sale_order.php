...
class ControllerReportSaleOrder extends Controller {
    ...
    public function item() {
        ...
        $data['breadcrumbs'][] = array(
            'text' => $this->language->get('heading_title'),
            'href' => $this->url->link('report/sale_order/item', 'token=' . $this->session->data['token'] . $url, 'SSL')
        );
        ...
        $order_total = $this->model_report_sale->getTotalOrderItems($filter_data);

        $results = $this->model_report_sale->getOrderItems($filter_data);
        ...
        $data['text_list'] = $this->language->get('text_order_items');
        $data['text_no_results'] = $this->language->get('text_no_results');
        $data['text_confirm'] = $this->language->get('text_confirm');
        $data['text_all_status'] = $this->language->get('text_all_status');
        ...
        $this->response->setOutput($this->load->view('report/sale_order_item.tpl', $data));
    }
    ...
    public function export_items() {
        ...
        $results = $this->model_report_sale->getOrderItems($filter_data);
        $str = "Order ID,Customer,Telephone, Product, Price, Quantity, Total".PHP_EOL;

        foreach ($results as $result) {
            $str .= $arrayToCsvLine(array(
                'order_id' => $result["order_id"],
                'customer' => $result["customer"],
                'telephone' => $result["telephone"],
                'name' => $result["name"],
