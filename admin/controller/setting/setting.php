...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
        ...
        $data['entry_article_limit_admin'] = $this->language->get('entry_article_limit_admin');
		...
		$data['entry_include_brand_navigation'] = $this->language->get('entry_include_brand_navigation');
		...
		$data['entry_address_registration'] = $this->language->get('entry_address_registration');
		$data['entry_otp_verification'] = $this->language->get('entry_otp_verification');
		...
		$data['entry_order_print_status'] = $this->language->get('entry_order_print_status');
		$data['entry_processing_status'] = $this->language->get('entry_processing_status');
		$data['entry_complete_status'] = $this->language->get('entry_complete_status');
		$data['entry_order_alter'] = $this->language->get('entry_order_alter');
        ...
        $data['entry_article_image_category'] = $this->language->get('entry_article_image_category');
        $data['entry_article_image_thumb'] = $this->language->get('entry_article_image_thumb');
        $data['entry_image_article_list'] = $this->language->get('entry_image_article_list');
		...
		$data['entry_sms_alert'] = $this->language->get('entry_sms_alert');
		$data['entry_restock_alert'] = $this->language->get('entry_restock_alert');
		$data['entry_order_create_sms'] = $this->language->get('entry_order_create_sms');
		...
		$data['help_article_limit_admin'] = $this->language->get('help_article_limit_admin');
		...
		$data['help_include_brand_navigation'] = $this->language->get('help_include_brand_navigation');
		...
		$data['help_address_registration'] = $this->language->get('help_address_registration');
		...
		$data['help_order_alter'] = $this->language->get('help_order_alter');
		...
		$data['help_sms_alert'] = $this->language->get('help_sms_alert');
		...
		$data['tab_mail_sms'] = $this->language->get('tab_mail_sms');
        ...
        if (isset($this->error['article_image_category'])) {
            $data['error_article_image_category'] = $this->error['article_image_category'];
        } else {
            $data['error_article_image_category'] = '';
        }

        if (isset($this->error['article_image_thumb'])) {
            $data['error_article_image_thumb'] = $this->error['article_image_thumb'];
        } else {
            $data['error_article_image_thumb'] = '';
        }

        if (isset($this->error['image_article_list'])) {
            $data['error_image_article_list'] = $this->error['image_article_list'];
        } else {
            $data['error_image_article_list'] = '';
        }
        ...
        if (isset($this->error['article_limit_admin'])) {
			$data['error_article_limit_admin'] = $this->error['article_limit_admin'];
		} else {
			$data['error_article_limit_admin'] = '';
		}
		...
		if (isset($this->request->post['config_region_id'])) {
			$data['config_region_id'] = $this->request->post['config_region_id'];
		} else {
			$data['config_region_id'] = $this->config->get('config_region_id');
		}
        ...
        if (isset($this->request->post['config_article_limit'])) {
			$data['config_article_limit'] = $this->request->post['config_article_limit'];
		} else {
			$data['config_article_limit'] = $this->config->get('config_article_limit');
		}
        ...
        if (isset($this->request->post['config_article_limit_admin'])) {
			$data['config_article_limit_admin'] = $this->request->post['config_article_limit_admin'];
		} else {
			$data['config_article_limit_admin'] = $this->config->get('config_article_limit_admin');
		}
		...
		if (isset($this->request->post['config_navigation_type'])) {
			$data['config_navigation_type'] = $this->request->post['config_navigation_type'];
		} else {
			$data['config_navigation_type'] = $this->config->get('config_navigation_type');
		}

        if (isset($this->request->post['config_include_brand_navigation'])) {
			$data['config_include_brand_navigation'] = $this->request->post['config_include_brand_navigation'];
		} else {
			$data['config_include_brand_navigation'] = $this->config->get('config_include_brand_navigation');
		}
        ...
        if (isset($this->request->post['config_address_registration'])) {
			$data['config_address_registration'] = $this->request->post['config_address_registration'];
		} else {
			$data['config_address_registration'] = $this->config->get('config_address_registration');
		}

		if (isset($this->request->post['config_otp_verification'])) {
			$data['config_otp_verification'] = $this->request->post['config_otp_verification'];
		} else {
			$data['config_otp_verification'] = $this->config->get('config_otp_verification');
		}
		...
		if (isset($this->request->post['config_order_print_status_id'])) {
			$data['config_order_print_status_id'] = $this->request->post['config_order_print_status_id'];
		} else {
			$data['config_order_print_status_id'] = $this->config->get('config_order_print_status_id');
		}
		...
		if (isset($this->request->post['config_order_alter'])) {
			$data['config_order_alter'] = $this->request->post['config_order_alter'];
		} else {
			$data['config_order_alter'] = $this->config->get('config_order_alter');
		}
		...
		if (isset($this->request->post['config_featured_image_width'])) {
			$data['config_featured_image_width'] = $this->request->post['config_featured_image_width'];
		} else {
			$data['config_featured_image_width'] = $this->config->get('config_featured_image_width');
		}

		if (isset($this->request->post['config_featured_image_height'])) {
			$data['config_featured_image_height'] = $this->request->post['config_featured_image_height'];
		} else {
			$data['config_featured_image_height'] = $this->config->get('config_featured_image_height');
		}
...
//Article Image Config Start

        if (isset($this->request->post['config_article_image_category_width'])) {
            $data['config_article_image_category_width'] = $this->request->post['config_article_image_category_width'];
        } else {
            $data['config_article_image_category_width'] = $this->config->get('config_article_image_category_width');
        }

        if (isset($this->request->post['config_article_image_category_height'])) {
            $data['config_article_image_category_height'] = $this->request->post['config_article_image_category_height'];
        } else {
            $data['config_article_image_category_height'] = $this->config->get('config_article_image_category_height');
        }

        if (isset($this->request->post['config_article_image_thumb_width'])) {
            $data['config_article_image_thumb_width'] = $this->request->post['config_article_image_thumb_width'];
        } else {
            $data['config_article_image_thumb_width'] = $this->config->get('config_article_image_thumb_width');
        }

        if (isset($this->request->post['config_article_image_thumb_height'])) {
            $data['config_article_image_thumb_height'] = $this->request->post['config_article_image_thumb_height'];
        } else {
            $data['config_article_image_thumb_height'] = $this->config->get('config_article_image_thumb_height');
        }


        if (isset($this->request->post['config_image_article_list_width'])) {
            $data['config_image_article_list_width'] = $this->request->post['config_image_article_list_width'];
        } else {
            $data['config_image_article_list_width'] = $this->config->get('config_image_article_list_width');
        }

        if (isset($this->request->post['config_image_article_list_height'])) {
            $data['config_image_article_list_height'] = $this->request->post['config_image_article_list_height'];
        } else {
            $data['config_image_article_list_height'] = $this->config->get('config_image_article_list_height');
        }
        //Article Image Config End
        ...
        if (isset($this->request->post['config_restock_alert'])) {
            $data['config_restock_alert'] = $this->request->post['config_restock_alert'];
        } else {
            $data['config_restock_alert'] = $this->config->get('config_restock_alert');
        }

        if (isset($this->request->post['config_order_create_sms'])) {
            $data['config_order_create_sms'] = $this->request->post['config_order_create_sms'];
        } else {
            $data['config_order_create_sms'] = $this->config->get('config_order_create_sms');
        }
	...
	protected function validate() {
		...
		if (!$this->request->post['config_featured_image_width'] || !$this->request->post['config_featured_image_height']) {
        ...
        if (!$this->request->post['config_article_image_category_width'] || !$this->request->post['config_article_image_category_height']) {
            $this->error['article_image_category'] = $this->language->get('error_article_image_category');
        }

        if (!$this->request->post['config_article_image_thumb_width'] || !$this->request->post['config_article_image_thumb_height']) {
            $this->error['article_image_thumb'] = $this->language->get('error_article_image_thumb');
        }

        if (!$this->request->post['config_image_article_list_width'] || !$this->request->post['config_image_article_list_height']) {
            $this->error['image_article_list'] = $this->language->get('error_image_article_list');
        }
        ...
        if (!$this->request->post['config_article_limit']) {
        ...
        if (!$this->request->post['config_article_limit_admin']) {
            $this->error['article_limit_admin'] = $this->language->get('error_limit');
        }
	...
	public function zone() {
		...
		if ($zone_info) {
			...
			$json = array(
				...
				'name'              => $zone_info['name'],
				'region'              => $this->model_localisation_region->getRegionsByZoneId($this->request->get['zone_id']),
