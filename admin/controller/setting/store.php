...
class ControllerSettingStore extends Controller {
	...
	public function getForm() {
		...
		} elseif (isset($store_info['config_featured_image_width'])) {
			$data['config_featured_image_width'] = $store_info['config_featured_image_width'];
		} else {
			$data['config_featured_image_width'] = 500;
		}
		...
		} elseif (isset($store_info['config_featured_image_height'])) {
			$data['config_featured_image_height'] = $store_info['config_featured_image_height'];
		} else {
			$data['config_featured_image_height'] = 500;
		}
	...
	protected function validateForm() {
		...
		if ((utf8_strlen($this->request->post['config_telephone']) < 3) || (utf8_strlen($this->request->post['config_telephone']) > 132)) {
