...
class ControllerCatalogReview extends Controller {
	...
	public function delete() {
        ...
        if(isset($this->request->get['review_id'])) {
            $selected[] = $this->request->get['review_id'];
        }
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['review_id'])) {
            ...
            $data['delete'] = $this->url->link('catalog/review/delete', 'token=' . $this->session->data['token'] . '&review_id=' . $this->request->get['review_id'] . $url, 'SSL');
