...
class ControllerCatalogInformation extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->model_user_user->addActivity($this->user->getId(), 'add_information', $activity_data, $information_id);
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->model_user_user->addActivity($this->user->getId(), 'edit_information', $activity_data, $this->request->get['information_id']);
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $information_id) {
                ...
                $this->model_user_user->addActivity($this->user->getId(), 'delete_information', $activity_data, $information_id);
			}
