...
class ControllerCatalogOption extends Controller {
    ...
    protected function validateForm() {
        ...
        if (($this->request->post['type'] == 'select' || $this->request->post['type'] == 'radio') && !isset($this->request->post['option_value'])) {
                ...
                if ($option['type'] == 'select' || $option['type'] == 'radio') {
                    ...
                    foreach ($option_values as $option_value) {
                        ...
                        $option_value_data[] = array(
                            ...
                            'color'           => strip_tags(html_entity_decode($option_value['color'], ENT_QUOTES, 'UTF-8'))
                        );
                    }
