<?php
class ControllerArticleDashboardCustomer extends Controller {
	public function index() {
		$this->load->language('article_dashboard/customer');
		...
		return $this->load->view('article_dashboard/customer.tpl', $data);
	}
}