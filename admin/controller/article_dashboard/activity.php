<?php
class ControllerArticleDashboardActivity extends Controller {
	public function index() {
		$this->load->language('article_dashboard/activity');
		...
		return $this->load->view('article_dashboard/activity.tpl', $data);
	}
}
