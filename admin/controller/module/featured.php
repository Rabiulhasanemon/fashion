...
class ControllerModuleFeatured extends Controller {
	...
	public function index() {
        ...
        $data['text_flash_sale'] = $this->language->get('text_flash_sale');
	...
	public function install() {
		...
		$this->model_user_user_group->addPermission($this->user->getGroupId(), 'access', 'module/featured');
		$this->model_user_user_group->addPermission($this->user->getGroupId(), 'modify', 'module/featured');
	}

	public function uninstall() {
		// Nothing required; instances are managed by core uninstall
	}
