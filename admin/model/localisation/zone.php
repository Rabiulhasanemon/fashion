...
class ModelLocalisationZone extends Model {
	...
	public function getZone($zone_id) {
		$query = $this->db->query("SELECT DISTINCT z.*, c.name as country FROM " . DB_PREFIX . "zone z LEFT JOIN " . DB_PREFIX . "country c on z.country_id = c.country_id WHERE z.zone_id = '" . (int)$zone_id . "'");
	...
	public function getZones($data = array()) {
        ...
        if (!empty($data['zone_name'])) {
            $sql .= " WHERE z.name LIKE '" . $this->db->escape($data['zone_name']) . "%'";
        }
