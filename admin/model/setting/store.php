...
class ModelSettingStore extends Model {
	...
	public function getTotalStoresByRegionId($zone_id) {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "setting WHERE `key` = 'config_region_id' AND `value` = '" . (int)$zone_id . "' AND store_id != '0'");
