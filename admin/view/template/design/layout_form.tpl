          ...
          <table id="module" class="table table-striped table-bordered table-hover">
            <thead>
              <tr>
                ...
                <td class="text-left"><?php echo $entry_device; ?></td>
            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                  ...
                  <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][device]" class="form-control">
                          <?php if ($layout_module['device'] == 'b') { ?>
                          <option value="b" selected="selected"><?php echo $text_both; ?></option>
                          <?php } else { ?>
                          <option value="b"><?php echo $text_both; ?></option>
                          <?php } ?>
                          <?php if ($layout_module['device'] == 'd') { ?>
                          <option value="d" selected="selected"><?php echo $text_desktop; ?></option>
                          <?php } else { ?>
                          <option value="d"><?php echo $text_desktop; ?></option>
                          <?php } ?>
                          <?php if ($layout_module['device'] == 'm') { ?>
                          <option value="m" selected="selected"><?php echo $text_mobile; ?></option>
                          <?php } else { ?>
                          <option value="m"><?php echo $text_mobile; ?></option>
                          <?php } ?>
                      </select></td>
...
function addModule() {
    ...
    html += '  </select></td>';
    html += '  <td class="text-left"><select name="layout_module[' + module_row + '][device]" class="form-control">';
    html += '    <option value="b"><?php echo $text_both; ?></option>';
    html += '    <option value="d"><?php echo $text_desktop; ?></option>';
    html += '    <option value="m"><?php echo $text_mobile; ?></option>';
    html += '  </select></td>';
