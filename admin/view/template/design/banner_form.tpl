          ...
          <table id="images" class="table table-striped table-bordered table-hover">
            <thead>
              <tr>
                ...
                <td class="text-left"><?php echo $entry_blurb; ?></td>
                <td class="text-left"><?php echo $entry_link; ?></td>
                <td class="text-left"><?php echo $entry_group_class; ?></td>
                <td class="text-left"><?php echo $entry_class; ?></td>
            ...
            <tbody>
              ...
              <tr id="image-row<?php echo $image_row; ?>">
                ...
                <td class="text-left"><?php foreach ($languages as $language) { ?>
                  <div class="input-group pull-left"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> </span>
                    <input type="text" name="banner_image[<?php echo $image_row; ?>][banner_image_description][<?php echo $language['language_id']; ?>][blurb]" value="<?php echo isset($banner_image['banner_image_description'][$language['language_id']]) ? $banner_image['banner_image_description'][$language['language_id']]['blurb'] : ''; ?>" placeholder="<?php echo $entry_blurb; ?>" class="form-control" />
                  </div>
                  <?php if (isset($error_banner_image[$image_row][$language['language_id']])) { ?>
                  <div class="text-danger"><?php echo $error_banner_image[$image_row][$language['language_id']]; ?></div>
                  <?php } ?>
                ...
                <td class="text-left" style="min-width: 10%;"><input type="text" name="banner_image[<?php echo $image_row; ?>][link]" value="<?php echo $banner_image['link']; ?>" placeholder="<?php echo $entry_link; ?>" class="form-control" /></td>
                <td class="text-left" style="min-width: 10%;"><input type="text" name="banner_image[<?php echo $image_row; ?>][group_class]" value="<?php echo $banner_image['group_class']; ?>" placeholder="<?php echo $entry_group_class; ?>" class="form-control" /></td>
                <td class="text-left" style="min-width: 10%;"><input type="text" name="banner_image[<?php echo $image_row; ?>][image_class]" value="<?php echo $banner_image['image_class']; ?>" placeholder="<?php echo $entry_class; ?>" class="form-control" /></td>
...
function addImage() {
    ...
    <?php foreach ($languages as $language) { ?>
    html += '    <div class="input-group">';
    html += '      <span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span><input type="text" name="banner_image[' + image_row + '][banner_image_description][<?php echo $language['language_id']; ?>][blurb]" value="" placeholder="<?php echo $entry_blurb; ?>" class="form-control" />';
    html += '    </div>';
    <?php } ?>
    html += '  </td>';
	...
	html += '  <td class="text-left"><input type="text" name="banner_image[' + image_row + '][group_class]" value="" placeholder="<?php echo $entry_group_class; ?>" class="form-control" /></td>';
	html += '  <td class="text-left"><input type="text" name="banner_image[' + image_row + '][image_class]" value="" placeholder="<?php echo $entry_class; ?>" class="form-control" /></td>';
