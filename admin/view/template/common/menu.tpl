<ul id="menu">
  ...
  <li id="article-dashboard"><a href="<?php echo $article_dashboard; ?>"><i class="fa fa-dashboard fa-fw"></i> <span><?php echo $text_article_dashboard; ?></span></a></li>
    ...
    <ul>
      ...
      <li><a class="parent"><?php echo $text_filter; ?></a>
        <ul>
          ...
          <li><a href="<?php echo $filter_profile; ?>"><?php echo $text_filter_profile; ?></a></li>
        </ul>
      </li>
      <li><a class="parent"><?php echo $text_attribute; ?></a>
        <ul>
          <li><a href="<?php echo $attribute; ?>"><?php echo $text_attribute; ?></a></li>
          <li><a href="<?php echo $attribute_profile; ?>"><?php echo $text_attribute_profile; ?></a></li>
        </ul>
      </li>
      ...
      <li><a href="<?php echo $question; ?>"><?php echo $text_question; ?></a></li>
      <li><a href="<?php echo $information; ?>"><?php echo $text_information; ?></a></li>
      <li><a href="<?php echo $landing_page; ?>"><?php echo $text_landing_page; ?></a></li>
      <li><a href="<?php echo $enquiry; ?>"><?php echo $text_enquiry; ?></a></li>
      <li><a href="<?php echo $offer; ?>"><?php echo $text_offer; ?></a></li>
      <li><a href="<?php echo $category_manufacturer; ?>"><?php echo $text_category_manufacturer; ?></a></li>
      <li><a href="<?php echo $restock_request; ?>"><?php echo $text_restock_request; ?></a></li>
      <li><a href="<?php echo $product_update_request; ?>"><?php echo $text_product_update_request; ?></a></li>
    </ul>
  </li>
  <li id="blog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_blog; ?></span></a>
    <ul>
      <li><a href="<?php echo $blog_category; ?>"><?php echo $text_category; ?></a></li>
      <li><a href="<?php echo $blog_event_stream; ?>"><?php echo $text_event_stream; ?></a></li>
      <li><a href="<?php echo $blog_article; ?>"><?php echo $text_article; ?></a></li>
      <li><a href="<?php echo $blog_comment; ?>"><?php echo $text_comment; ?></a></li>
    </ul>
  </li>
  <li id="form"><a class="parent"><i class="fa fa-list"></i> <span><?php echo $text_form; ?></span></a>
    <ul>
      <li><a href="<?php echo $event_participant; ?>"><?php echo $text_event_participant; ?></a></li>
    </ul>
  </li>
  ...
  <li id="sale"><a class="parent"><i class="fa fa-shopping-cart fa-fw"></i> <span><?php echo $text_sale; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $sale_payment; ?>"><?php echo $text_payment; ?></a></li>
    ...
    <ul>
      ...
      <li><a class="parent"><?php echo $text_design; ?></a>
        <ul>
          ...
          <li><a href="<?php echo $ads_position; ?>"><?php echo $text_ads_position; ?></a></li>
      ...
      <li><a href="<?php echo $operator; ?>"><?php echo $text_operator; ?></a></li>
      <li><a class="parent"><?php echo $text_localisation; ?></a>
        <ul>
          ...
          <li><a href="<?php echo $region; ?>"><?php echo $text_region; ?></a></li>
      ...
      <li><a href="<?php echo $permanent_redirect; ?>"><?php echo $text_permanent_redirect; ?></a></li>
    ...
    <ul>
      <li><a class="parent"><?php echo $text_sale; ?></a>
        <ul>
          ...
          <li><a href="<?php echo $report_sale_order_item; ?>"><?php echo $text_order_item; ?></a></li>
