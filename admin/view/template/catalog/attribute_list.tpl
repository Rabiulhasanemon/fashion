  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <button type="button" data-toggle="tooltip" title="<?php echo $button_copy; ?>" class="btn btn-default" onclick="$('#form-attribute').attr('action', '<?php echo $copy; ?>').submit()"><i class="fa fa-copy"></i></button>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <select name="filter_profile_id" id="input-profile-id" class="form-control">
                    ...
                    <?php if ($attribute_profile['attribute_profile_id'] == $filter_profile_id) { ?>
                    <option value="<?php echo $attribute_profile['attribute_profile_id']; ?>" selected="selected"><?php echo $attribute_profile['name']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $attribute_profile['attribute_profile_id']; ?>"><?php echo $attribute_profile['name']; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select>
                </div>
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($attribute['attribute_group_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $attribute['attribute_group_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $attribute['attribute_group_id']; ?>" />
                    <?php } ?></td>
