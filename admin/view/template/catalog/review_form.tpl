  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <?php if(isset($delete)) { ?><a href="<?php echo $delete; ?>" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="return confirm('<?php echo $text_confirm; ?>')"><i class="fa fa-trash-o"></i></a><?php } ?>
