  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <a href="<?php echo $import; ?>" data-toggle="tooltip" title="<?php echo $button_import; ?>" class="btn btn-default"><i class="fa fa-upload"></i></a>
        ...
        <div class="well">
          <div class="row">
            <div class="col-sm-4">
              ...
              <div class="form-group">
                <label class="control-label" for="input-manufacture-name"><?php echo $entry_manufacturer; ?></label>
            ...
            <div class="col-sm-4">
              ...
              <button type="button" id="button-download" class="btn btn-primary pull-right" style="margin-right: 10px"><i class="fa fa-download"></i> <?php echo $button_download; ?></button>
            </div>
          </div>
        </div>
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'pd.name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><?php if ($sort == 'p.regular_price') { ?>
                    <a href="<?php echo $sort_regular_price; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_regular_price; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_regular_price; ?>"><?php echo $column_regular_price; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center"><?php if ($product['image']) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php echo $product['name']; ?><br><?php echo $product['model']; ?></td>
                  <td class="text-left"><?php echo $product['regular_price']; ?></td>
...
$('#button-download').on('click', function() {
  var url = 'index.php?route=catalog/product/download&token=<?php echo $token; ?>';
