 ...
 <Worksheet ss:Name="Sheet1">
  ...
  <?php foreach($products as $product) { ?>
   <Row ss:AutoFitHeight="0">
    <Cell ss:StyleID="s70"><Data ss:Type="Number"><?php echo $product['product_id']; ?></Data></Cell>
    <Cell ss:StyleID="s67"><Data ss:Type="String"><?php echo $product['name']; ?></Data></Cell>
    <Cell ss:StyleID="s67"><Data ss:Type="String"><?php echo $product['model']; ?></Data></Cell>
    <Cell ss:StyleID="s67"><Data ss:Type="String"><?php echo $product['price']; ?></Data></Cell>
    <Cell ss:StyleID="s67"><Data ss:Type="String"><?php echo $product['status']; ?></Data></Cell>
    <Cell ss:StyleID="s67"><Data ss:Type="String"><?php echo $product['quantity']; ?></Data></Cell>
    <Cell ss:StyleID="s72"><Data ss:Type="String"><?php echo $product['date_added']; ?></Data></Cell>
   </Row>
  <?php } ?>
  </Table>
