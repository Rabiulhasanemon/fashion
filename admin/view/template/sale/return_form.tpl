        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-return" class="form-horizontal">
          ...
          <div class="tab-pane active" id="tab-general">
            ...
            <fieldset>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-freight"><?php echo $entry_freight; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="freight" value="<?php echo $freight; ?>" placeholder="<?php echo $entry_freight; ?>" id="input-freight" class="form-control" />
                  <?php if ($error_freight) { ?>
                  <div class="text-danger"><?php echo $error_freight; ?></div>
                  <?php  } ?>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-tracking"><?php echo $entry_tracking_no; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="tracking_no" value="<?php echo $tracking_no; ?>" placeholder="<?php echo $entry_tracking_no; ?>" id="input-tracking" class="form-control" />
                  <?php if ($error_tracking_no) { ?>
                  <div class="text-danger"><?php echo $error_tracking_no; ?></div>
                  <?php  } ?>
                </div>
              </div>
              <div class="form-group">
