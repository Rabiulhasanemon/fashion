                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab-address<?php echo $address_row; ?>">
                      ...
                      <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                          <select name="address[<?php echo $address_row; ?>][zone_id]" id="input-zone<?php echo $address_row; ?>" class="form-control"  onchange="zone(this, '<?php echo $address_row; ?>', '<?php echo $address['region_id']; ?>');">
                          </select>
                      ...
                      <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-region<?php echo $address_row; ?>"><?php echo $entry_region; ?></label>
                        <div class="col-sm-10">
                          <select name="address[<?php echo $address_row; ?>][region_id]" id="input-region<?php echo $address_row; ?>" class="form-control">
                          </select>
                          <?php if (isset($error_address[$address_row]['region'])) { ?>
                          <div class="text-danger"><?php echo $error_address[$address_row]['region']; ?></div>
                          <?php } ?>
                        </div>
                      </div>
                      <?php foreach ($custom_fields as $custom_field) { ?>
...
function addAddress() {
    ...
    <?php foreach ($countries as $country) { ?>
    html += '         <option value="<?php echo $country['country_id']; ?>" <?php echo $country["country_id"] == $config_country_id ? "selected" : "" ?>><?php echo addslashes($country['name']); ?></option>';
    <?php } ?>
    html += '      </select></div>';
	html += '  </div>';
	...
	html += '  <div class="form-group required">';
	html += '    <label class="col-sm-2 control-label" for="input-region' + address_row + '"><?php echo $entry_region; ?></label>';
	html += '    <div class="col-sm-10"><select name="address[' + address_row + '][region_id]" id="input-region' + address_row + '" class="form-control"><option value=""><?php echo $text_none; ?></option></select></div>';
	html += '  </div>';
...
function zone(element, index, region_id) {
	$.ajax({
		...
		success: function(json) {
			...
			if (json['region'] && json['region'] != '') {
				for (i = 0; i < json['region'].length; i++) {
					...
					if (json['region'][i]['region_id'] == region_id) {
						html += ' selected="selected"';
					}
			...
			$('select[name=\'address[' + index + '][region_id]\']').html(html);
		},
		error: function(xhr, ajaxOptions, thrownError) {
			alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
		}
