...
function genURL(url) {
    ...
    var filter_customer = $('[name=\'filter_customer\']').val();
...
$('#button-filter').on('click', function() {
	var url = genURL('index.php?route=report/sale_order/item&token=<?php echo $token; ?>');
	location = url;
});

$('#button-download').on('click', function() {
    var url = 'index.php?route=report/sale_order/export_items&token=<?php echo $token; ?>';
