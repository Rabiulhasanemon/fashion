    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form class="form-horizontal">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="to" id="input-to" class="form-control">
                <option value="single"><?php echo $text_single; ?></option>
          ...
          <div class="form-group to" id="to-single">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <textarea maxlength="158" name="message" placeholder="<?php echo $entry_message; ?>" id="input-message" class="form-control"></textarea>
            </div>
          </div>
        </form>
      </div>
