      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-mail" data-toggle="tab"><?php echo $tab_mail_sms; ?></a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-local">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="config_region_id" id="input-region" class="form-control">
                  </select>
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-option">
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_navigation_type; ?>"><?php echo $entry_navigation_type; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_navigation_type === 'navigation') { ?>
                      <input type="radio" name="config_navigation_type" value="navigation" checked="checked" />
                      <?php echo $text_navigation; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_navigation_type" value="navigation" />
                      <?php echo $text_navigation; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if ($config_navigation_type === 'category') { ?>
                      <input type="radio" name="config_navigation_type" value="category" checked="checked" />
                      <?php echo $text_category; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_navigation_type" value="category" />
                      <?php echo $text_category; ?>
                      <?php } ?>
                    </label>
                  </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_include_brand_navigation; ?>"><?php echo $entry_include_brand_navigation; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_include_brand_navigation) { ?>
                      <input type="radio" name="config_include_brand_navigation" value="1" checked="checked" />
                      <?php echo $text_yes; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_include_brand_navigation" value="1" />
                      <?php echo $text_yes; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if (!$config_include_brand_navigation) { ?>
                      <input type="radio" name="config_include_brand_navigation" value="0" checked="checked" />
                      <?php echo $text_no; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_include_brand_navigation" value="0" />
                      <?php echo $text_no; ?>
                      <?php } ?>
                    </label>
                  </div>
                ...
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-catalog-article-limit"><span data-toggle="tooltip" title="<?php echo $help_article_limit; ?>"><?php echo $entry_article_limit; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_article_limit" value="<?php echo $config_article_limit; ?>" placeholder="<?php echo $entry_article_limit; ?>" id="input-catalog-article-limit" class="form-control" />
                ...
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-admin-article-limit"><span data-toggle="tooltip" title="<?php echo $help_article_limit_admin; ?>"><?php echo $entry_article_limit_admin; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_article_limit_admin" value="<?php echo $config_article_limit_admin; ?>" placeholder="<?php echo $entry_article_limit_admin; ?>" id="input-admin-article-limit" class="form-control" />
                    <?php if ($error_article_limit_admin) { ?>
                    <div class="text-danger"><?php echo $error_article_limit_admin; ?></div>
                    <?php } ?>
                  </div>
                </div>
              </fieldset>
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_address_registration; ?>"><?php echo $entry_address_registration; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_address_registration) { ?>
                      <input type="radio" name="config_address_registration" value="1" checked="checked" />
                      <?php echo $text_yes; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_address_registration" value="1" />
                      <?php echo $text_yes; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if (!$config_address_registration) { ?>
                      <input type="radio" name="config_address_registration" value="0" checked="checked" />
                      <?php echo $text_no; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_address_registration" value="0" />
                      <?php echo $text_no; ?>
                      <?php } ?>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><?php echo $entry_otp_verification; ?></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_otp_verification) { ?>
                      <input type="radio" name="config_otp_verification" value="1" checked="checked" />
                      <?php echo $text_yes; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_otp_verification" value="1" />
                      <?php echo $text_yes; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if (!$config_otp_verification) { ?>
                      <input type="radio" name="config_otp_verification" value="0" checked="checked" />
                      <?php echo $text_no; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_otp_verification" value="0" />
                      <?php echo $text_no; ?>
                      <?php } ?>
                    </label>
                  </div>
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-order-print-status"><?php echo $entry_order_print_status; ?></label>
                  <div class="col-sm-10">
                    <select name="config_order_print_status_id" id="input-order-print-status" class="form-control">
                      <option value=""><?php echo $text_none; ?></option>
                      <?php foreach ($order_statuses as $order_status) { ?>
                      <?php if ($order_status['order_status_id'] == $config_order_print_status_id) { ?>
                      <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                      <?php } else { ?>
                      <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                      <?php } ?>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_order_alter; ?>"><?php echo $entry_order_alter; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_order_alter) { ?>
                      <input type="radio" name="config_order_alter" value="1" checked="checked" />
                      <?php echo $text_yes; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_order_alter" value="1" />
                      <?php echo $text_yes; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if (!$config_order_alter) { ?>
                      <input type="radio" name="config_order_alter" value="0" checked="checked" />
                      <?php echo $text_no; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_order_alter" value="0" />
                      <?php echo $text_no; ?>
                      <?php } ?>
                    </label>
                  </div>
            ...
            <div class="tab-pane" id="tab-image">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-image-popup-width"><?php echo $entry_featured_image; ?></label>
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-sm-6">
                      <input type="text" name="config_featured_image_width" value="<?php echo $config_featured_image_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-image-popup-width" class="form-control" />
                    </div>
                    <div class="col-sm-6">
                      <input type="text" name="config_featured_image_height" value="<?php echo $config_featured_image_height; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" />
                    </div>
                  </div>
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-article-image-category-width"><?php echo $entry_article_image_category; ?></label>
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-sm-6">
                      <input type="text" name="config_article_image_category_width" value="<?php echo $config_article_image_category_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-article-image-category-width" class="form-control" />
                    </div>
                    <div class="col-sm-6">
                      <input type="text" name="config_article_image_category_height" value="<?php echo $config_article_image_category_height; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" />
                    </div>
                  </div>
                  <?php if ($error_article_image_category) { ?>
                  <div class="text-danger"><?php echo $error_article_image_category; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-article-image-thumb-width"><?php echo $entry_article_image_thumb; ?></label>
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-sm-6">
                      <input type="text" name="config_article_image_thumb_width" value="<?php echo $config_article_image_thumb_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-article-image-thumb-width" class="form-control" />
                    </div>
                    <div class="col-sm-6">
                      <input type="text" name="config_article_image_thumb_height" value="<?php echo $config_article_image_thumb_height; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" />
                    </div>
                  </div>
                  <?php if ($error_article_image_thumb) { ?>
                  <div class="text-danger"><?php echo $error_article_image_thumb; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-image-article-list-width"><?php echo $entry_image_article_list; ?></label>
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-sm-6">
                      <input type="text" name="config_image_article_list_width" value="<?php echo $config_image_article_list_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-image-article-list-width" class="form-control" />
                    </div>
                    <div class="col-sm-6">
                      <input type="text" name="config_image_article_list_height" value="<?php echo $config_image_article_list_height; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" />
                    </div>
                  </div>
                  <?php if ($error_image_article_list) { ?>
                  <div class="text-danger"><?php echo $error_image_article_list; ?></div>
                  <?php } ?>
                </div>
              </div>
            ...
            <div class="tab-pane" id="tab-mail">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-alert-sms"><span data-toggle="tooltip" title="<?php echo $help_sms_alert; ?>"><?php echo $entry_sms_alert; ?></span></label>
                <div class="col-sm-10">
                  <textarea name="config_sms_alert" rows="5" placeholder="<?php echo $entry_sms_alert; ?>" id="input-alert-sms" class="form-control"><?php echo $config_sms_alert; ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-alert-restock"><?php echo $entry_restock_alert; ?></label>
                <div class="col-sm-10">
                  <textarea name="config_restock_alert" rows="5" placeholder="<?php echo $entry_restock_alert; ?>" id="input-alert-restock" class="form-control"><?php echo $config_restock_alert; ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-order-create"><?php echo $entry_order_create_sms; ?></label>
                <div class="col-sm-10">
                  <textarea name="config_order_create_sms"  rows="5" placeholder="<?php echo $entry_order_create_sms; ?>" id="input-order-create" class="form-control"><?php echo $config_order_create_sms; ?></textarea>
                </div>
              </div>
            </div>
...
$('select[name=\'config_zone_id\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=setting/setting/zone&token=<?php echo $token; ?>&zone_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
		...
		success: function(json) {
			...
			if (json['region'] && json['region'] != '') {
				for (i = 0; i < json['region'].length; i++) {
					...
					if (json['region'][i]['region_id'] == '<?php echo $config_region_id; ?>') {
            			html += ' selected="selected"';
					}
			...
			$('select[name=\'config_region_id\']').html(html);
		},
		error: function(xhr, ajaxOptions, thrownError) {
			alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
		}
