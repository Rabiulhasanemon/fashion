        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="category_description[<?php echo $language['language_id']; ?>][note]" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['note'] : ''; ?>" placeholder="<?php echo $entry_note; ?>" id="input-note<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="category_description[<?php echo $language['language_id']; ?>][summary]" placeholder="<?php echo $entry_summary; ?>" id="input-summary<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['summary'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-local"><?php echo $entry_local; ?></label>
                <div class="col-sm-10">
                  <div class="checkbox">
                    <label>
                      <?php if ($local) { ?>
                      <input type="checkbox" name="local" value="1" checked="checked" id="input-local" />
                      <?php } else { ?>
                      <input type="checkbox" name="local" value="1" id="input-local" />
                      <?php } ?>
                      &nbsp; </label>
                  </div>
                </div>
