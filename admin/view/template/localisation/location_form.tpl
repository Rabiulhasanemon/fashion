      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-location" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-finder"><?php echo $entry_zone; ?></label>
            <div class="col-sm-10">
              <input type="hidden" name="zone_id" value="<?php echo $zone_id; ?>">
              <input type="text" value="<?php echo $zone; ?>" placeholder="<?php echo $entry_zone; ?>" id="input-zone" name="zone" class="form-control" />
