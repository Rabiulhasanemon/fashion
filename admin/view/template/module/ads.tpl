    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-ads" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-ads_position"><?php echo $entry_ads_position; ?></label>
            <div class="col-sm-10">
              <select name="ads_position_id" id="input-ads_position" class="form-control">
