          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <div class="input-group datetime">
                <input type="text" id="input-date-end" name="date_end" value="<?php echo $date_end; ?>" placeholder="<?php echo $entry_date_end; ?>" data-date-format="YYYY-MM-DD HH:mm"  class="form-control" />
