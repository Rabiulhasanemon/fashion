    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-featured" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-child"><?php echo $entry_child; ?></label>
            <div class="col-sm-10">
              <select name="child" id="input-child" class="form-control">
                <?php if ($child) { ?>
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-child_limit"><?php echo $entry_child_limit; ?></label>
            <div class="col-sm-10">
              <input type="text" name="child_limit" value="<?php echo $child_limit; ?>" placeholder="<?php echo $entry_child_limit; ?>" id="input-child_limit" class="form-control" />
            </div>
          </div>
