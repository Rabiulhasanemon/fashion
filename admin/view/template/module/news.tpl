      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-html" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="type" id="input-type" class="form-control">
                ...
                <option value="headline" selected="selected"><?php echo $text_headline; ?></option>
                <option value="text"><?php echo $text_text; ?></option>
                <?php } else { ?>
                <option value="headline"><?php echo $text_headline; ?></option>
          ...
          <div class="form-group"id="news">
            ...
            <div class="col-sm-10">
              <textarea class="form-control" name="news" id="input-news"><?php echo $news;?></textarea>
              <?php if ($error_news) { ?>
