...
$registry->set('cacheManger', $cacheManger);
...
$date = new Date($languages[$code]['directory']);
$registry->set('date', $date);
$registry->set('translator', new Translator($languages[$code]['directory']));
...
// Mobile Detect
$registry->set('mobile_detect', new MobileDetect());
...
$event->register("post.customer.login", "checkout/restock_request/after_login");
...
// 301 Redirect
$controller->addPreAction(new Action('common/redirect'));
