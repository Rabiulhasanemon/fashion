...
class ModelAccountCustomer extends Model {
	public function addCustomer($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "address SET customer_id = '" . (int)$customer_id . "', firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape(isset($data['lastname']) ? $data['lastname'] : "") . "', company = '" . $this->db->escape(isset($data['company']) ? $data['company'] : "") . "', address_1 = '" . $this->db->escape($data['address_1']) . "', address_2 = '" . $this->db->escape(isset($data['address_2']) ? $data['address_2'] : "") . "', city = '" . $this->db->escape(isset($data['city']) ? $data['city'] : "") . "', postcode = '" . (isset($data['postcode']) ? $this->db->escape($data['postcode']) : "") . "', country_id = '" . (int)(isset($data['country_id']) ? $data['country_id'] : $this->config->get('config_country_id')) . "', zone_id = '" . (int)$data['zone_id']  . "', region_id = '" . (int)$data['region_id'] . "', custom_field = '" . $this->db->escape(isset($data['custom_field']['address']) ? serialize($data['custom_field']['address']) : '') . "'");
