...
$_['text_store_details']        = 'Store Details';
...
$_['text_new_footer']           = 'Please reply to this e-mail or call %s if you have any questions.';
...
$_['text_update_order_status_sms']  = 'Your order# %order_id has been updated to the following status: %status' . "\n" . ' For any enquiries, call %telephone';
$_['text_order_create_sms'] = 'Dear Customer, thank you for your order. Your Order ID is %s.' . "\n" . 'Our call center agent will get in touch with you shortly. For help call %s';
$_['text_new_received_sms']         = 'You have received an order. %s';