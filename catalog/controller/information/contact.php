...
class ControllerInformationContact extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
		    ...
		    $this->model_information_enquiry->addEnquiry($this->request->post);
	...
	protected function validate() {
        ...
        if ((utf8_strlen($this->request->post['phone']) < 11) || !preg_match('/^(016|017|018|015|019|011|013)[0-9]{8}$/i', $this->request->post['phone'])) {
