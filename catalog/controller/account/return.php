...
class ControllerAccountReturn extends Controller {
	...
	protected function validate() {
        ...
        if ((utf8_strlen($this->request->post['tracking_no']) < 3) || (utf8_strlen($this->request->post['tracking_no']) > 64)) {
            $this->error['tracking_no'] = $this->language->get('error_tracking_no');
        }

        if ((utf8_strlen($this->request->post['freight']) < 3) || (utf8_strlen($this->request->post['freight']) > 96)) {
