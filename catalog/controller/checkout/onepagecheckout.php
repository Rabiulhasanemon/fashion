...
class ControllerCheckoutOnepagecheckout extends Controller
{
    ...
    public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate_form()) {
            ...
            $order_data['payment_region'] = $region['name'];
            $order_data['payment_region_id'] = $region['region_id'];
            ...
            if ($this->cart->hasShipping()) {
                ...
                $order_data['shipping_region'] = $region['name'];
                $order_data['shipping_region_id'] = $region['region_id'];
