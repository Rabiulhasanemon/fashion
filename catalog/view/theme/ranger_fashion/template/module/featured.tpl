    ...
    <div class="featured-products__top">
      <div class="featured-products__top-main">
        <div class="featured-products__top-text">
          ...
          <div class="featured-products__see-all">
...
@media (max-width: 768px) {
  ...
  <div class="featured-products__wrapper content">
    <div class="featured-products__layout">
      <?php $featured_module_id = 'featured-' . uniqid(); ?>
      <ul class="list-unstyled featured-products__list content grid--6" id="featured-products-list-<?php echo $featured_module_id; ?>">
        <?php 
        $product_count = 0;
        foreach ($products as $product) { 
          $product_count++;
          $is_hidden = ($product_count > 6) ? 'featured-product-hidden' : ''; // Show 6 products by default
        ?>
        <li class="featured-products__item column-animation cart-content-center animate <?php echo $is_hidden; ?>" data-product-index="<?php echo $product_count; ?>">
          <div class="featured-card-wrapper color-background-1" data-product="<?php echo $product['product_id']; ?>">
            <div class="featured-card-wrapper__inner">
              <div class="featured-card__image-wrapper">
                ...
                <div class="featured-card__image">
                  <a href="<?php echo $product['href']; ?>">
                    <img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" loading="lazy" class="featured-product-img">
                  </a>
              ...
              <div class="featured-card__information">
...
.featured-card-wrapper:hover .featured-product-img {
...
.featured-card-wrapper:hover .featured-card__actions {
    bottom: 0;
}
