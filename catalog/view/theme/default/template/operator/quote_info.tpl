    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="main_content">
          <ul class="nav nav-tabs">
              <li class="active"><a href="#tab-quote" data-toggle="tab" aria-expanded="true"><?php echo $tab_quote; ?></a></li>
              <li class=""><a href="#tab-history" data-toggle="tab" aria-expanded="true"><?php echo $tab_history; ?></a></li>
          </ul>
...
<script>
    ...
    $(document).on("change", ".quote-price", function () {
        var totalDiscount = 0;
    ...
    $('#btn-print').on("click", function () {
        $('#quote-form').attr('action', decodeURI('<?php echo $print; ?>'.replace('&amp;', '&'))).submit()
    });
