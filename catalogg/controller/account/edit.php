...
class ControllerAccountEdit extends Controller {
	...
	protected function validate() {
        ...
        if (!$this->config->get('config_otp_verification') && ($this->customer->getTelephone() != $this->request->post['telephone']) && $this->model_account_customer->getTotalCustomersByTelephone($this->request->post['telephone'])) {
