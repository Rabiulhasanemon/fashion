...
class ControllerApiOrder extends Controller {
	public function add() {
		...
		if (!isset($this->session->data['api_id'])) {
			...
			if (!$json) {
				...
				$order_data['payment_region'] = $this->session->data['payment_address']['region'];
				$order_data['payment_region_id'] = $this->session->data['payment_address']['region_id'];
				...
				if ($this->cart->hasShipping()) {
					...
					$order_data['shipping_region'] = $this->session->data['shipping_address']['region'];
					$order_data['shipping_region_id'] = $this->session->data['shipping_address']['region_id'];
	...
	public function history() {
		...
		if (!isset($this->session->data['api_id'])) {
			...
			if ($order_info) {
				$this->model_checkout_order->addOrderHistory($order_id, $this->request->post['order_status_id'], $this->request->post['comment'], $this->request->post['notify'], $this->request->post['user_id']);
