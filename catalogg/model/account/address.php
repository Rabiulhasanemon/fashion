...
class ModelAccountAddress extends Model {
	public function addAddress($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "address SET customer_id = '" . (int)$this->customer->getId()
            . "', firstname = '" . $this->db->escape($data['firstname'])
            . "', lastname = '" . $this->db->escape(isset($this->request->post['lastname']) ? $this->request->post['lastname'] : "")
            . "', company = '" . $this->db->escape(isset($this->request->post['company']) ? $this->request->post['company'] : "")
            . "', address_1 = '" . $this->db->escape($data['address_1']) . "', address_2 = '"
            . $this->db->escape(isset($this->request->post['address_2']) ? $this->request->post['address_2'] : "")
            . "', postcode = '" . $this->db->escape(isset($this->request->post['postcode']) ? $this->request->post['postcode'] : "")
