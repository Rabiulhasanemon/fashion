		...
		success: function(json) {
			...
			if (json['error']) {
				if (json['error']['warning']) {
					...
					alertRow.append('<div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error']['warning'] + '<button type="button" class="close" data-dismiss="alert">&times;</button></div>');
...
$(document).delegate('#button-shipping', 'click', function() {
	$.ajax({
		url: 'checkout/shipping/shipping',
		type: 'post',
...
$('select[name=\'country_id\']').on('change', function() {
	$.ajax({
		url: 'checkout/shipping/country&country_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
